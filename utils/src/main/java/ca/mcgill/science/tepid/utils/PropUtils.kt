...
object PropsCreationInfo : PropHolder("${internalConfigLocation}config/creationInformation.properties", "config/creationInformation.properties") {
...
object PropsURL : PropHolder("${internalConfigLocation}config/URL.properties", "config/URL.properties") {
...
object PropsLDAP : PropHolder ("${internalConfigLocation}config/LDAP.properties", "config/LDAP.properties") {
...
object PropsLDAPResource : PropHolder ("${internalConfigLocation}config/LDAPResource.properties", "config/LDAPResource.properties") {
...
object PropsLDAPGroups : PropHolder ("${internalConfigLocation}config/LDAPGroups.properties", "config/LDAPGroups.properties") {
...
object PropsLDAPTestUser : PropHolder ("${internalConfigLocation}config/LDAPTestUser.properties", "config/LDAPTestUser.properties") {
...
object PropsDB : PropHolder ("${internalConfigLocation}config/DB.properties", "config/DB.properties") {
...
object PropsTEM : PropHolder("${internalConfigLocation}config/TEM.properties", "config/TEM.properties"){
    val TEM_URL by PropsTEM.string("TEM_URL", errorMessage = "TEM_URL not set")
}

object PropsBarcode : PropHolder("${internalConfigLocation}config/barcode.properties", "config/barcode.properties"){
...
object PropsScreensaver : PropHolder ("${internalConfigLocation}config/screensaver.properties", "config/screensaver.properties") {
