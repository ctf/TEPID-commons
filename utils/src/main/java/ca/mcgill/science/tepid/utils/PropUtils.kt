...
object PropsURL : PropHolder("${externalConfigLocation}URL.properties","${internalConfigLocation}config/URL.properties", "config/URL.properties") {
...
object PropsLDAP : PropHolder ("${externalConfigLocation}LDAP.properties", "${internalConfigLocation}config/LDAP.properties", "config/LDAP.properties") {
...
object PropsLDAPResource : PropHolder ("${externalConfigLocation}LDAPResource.properties", "${internalConfigLocation}config/LDAPResource.properties", "config/LDAPResource.properties") {
...
object PropsLDAPGroups : PropHolder ("${externalConfigLocation}LDAPGroups.properties", "${internalConfigLocation}config/LDAPGroups.properties", "config/LDAPGroups.properties") {
...
object PropsLDAPTestUser : PropHolder ("${externalConfigLocation}LDAPTestUser.properties", "${internalConfigLocation}config/LDAPTestUser.properties", "config/LDAPTestUser.properties") {
...
object PropsDB : PropHolder ("${externalConfigLocation}DB.properties", "${internalConfigLocation}config/DB.properties", "config/DB.properties") {
...
object PropsTEM : PropHolder("${externalConfigLocation}TEM.properties", "${internalConfigLocation}config/TEM.properties", "config/TEM.properties"){
    val TEM_URL by PropsTEM.string("TEM_URL", errorMessage = "TEM_URL not set")
}

object PropsBarcode : PropHolder("${externalConfigLocation}barcode.properties", "${internalConfigLocation}config/barcode.properties", "config/barcode.properties"){
...
object PropsScreensaver : PropHolder ("${externalConfigLocation}screensaver.properties", "${internalConfigLocation}config/screensaver.properties", "config/screensaver.properties") {
