...
public class User {
	public String displayName, givenName, middleName, lastName, shortUser, longUser, email, faculty, nick, realName, salutation, authType, role, password;
	public List<String> groups = new ArrayList<>(), preferredName;
	public Date activeSince;
	public Integer studentId;
	public long jobExpiration = TimeUnit.DAYS.toMillis(7);
	...
	public String toString() {
		return "LdapUser [displayName=" + displayName + ", givenName=" + givenName + ", middleName=" + middleName
				...
				+ ", faculty=" + faculty + ", nick=" + nick + ", realName=" + realName
